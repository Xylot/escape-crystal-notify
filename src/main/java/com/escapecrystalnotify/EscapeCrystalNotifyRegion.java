...
public enum EscapeCrystalNotifyRegion {
    ...
    BOSS_BRUTUS("Brutus", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, new EscapeCrystalNotifyRegionEntrance(EscapeCrystalNotifyRegionEntranceOverlayType.DEPRIORITIZED_WITH_HIGHLIGHT, List.of(833947), EscapeCrystalNotifyRegionEntranceObjectType.GAME_OBJECT, ObjectID.FENCEGATE_R_COWBOSS_START, ObjectID.FENCEGATE_L_COWBOSS_START).withInstancedBoss(), List.of(829849, 829850, 829851, 829852, 831894, 831895, 831896, 831897, 831898, 831899, 831900, 833942, 833943, 833944, 833945, 833946, 833947, 833948, 835990, 835991, 835992, 835993, 835994, 835995, 835996), 12850, 12851, 13106, 13107),
    ...
    BOSS_MAGGOT_KING("Maggot King", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 11645),
    BOSS_MAGGOT_KING_ENTRANCE("Maggot King Entrance", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, new EscapeCrystalNotifyRegionEntrance(EscapeCrystalNotifyRegionEntranceOverlayType.DEPRIORITIZED_WITH_HIGHLIGHT, List.of(685013), EscapeCrystalNotifyRegionEntranceObjectType.GAME_OBJECT, ObjectID.DARKWOOD_TREE_DOORWAY01_4X3), List.of(685013), 10618),
    BOSS_MAD_ANGEL("Mad Angel", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, new EscapeCrystalNotifyRegionEntrance(EscapeCrystalNotifyRegionEntranceOverlayType.DEPRIORITIZED_WITH_HIGHLIGHT, EscapeCrystalNotifyRegionEntranceDirection.WESTWARD, List.of(649492, 649493), EscapeCrystalNotifyRegionEntranceObjectType.GAME_OBJECT, 62250), 10018),
    ...
    BOSS_BRYOPHYTA("Bryophyta", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 12955),
    BOSS_BRYOPHYTA_ENTRANCE("Bryophyta Entrance", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, new EscapeCrystalNotifyRegionEntrance(EscapeCrystalNotifyRegionEntranceOverlayType.DEPRIORITIZED_WITH_HIGHLIGHT, List.of(812245), EscapeCrystalNotifyRegionEntranceObjectType.GAME_OBJECT, ObjectID.GB_MOSS_DOOR_IN), List.of(812245), 12698),
    ...
    BOSS_DOOM_OF_MOKHAIOTL("Doom of Mokhaiotl", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, new EscapeCrystalNotifyRegionEntrance(EscapeCrystalNotifyRegionEntranceOverlayType.DEPRIORITIZED_WITH_HIGHLIGHT, List.of(335018, 337066), false, true, EscapeCrystalNotifyRegionEntranceObjectType.GAME_OBJECT, ObjectID.DOM_ENTRANCE), 5268, 5269, 13668, 14180),
    ...
    BOSS_PRIFDDINAS_RABBIT_ENTRANCE("Prifddinas Rabbit Entrance", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, new EscapeCrystalNotifyRegionEntrance(EscapeCrystalNotifyRegionEntranceOverlayType.DEPRIORITIZED_WITH_HIGHLIGHT, List.of(580011), EscapeCrystalNotifyRegionEntranceObjectType.GAME_OBJECT, ObjectID.PRIF_RABBIT_CAVE_ENTRANCE), false, List.of(577962, 577963, 580011), 9013),
    ...
    BOSS_THE_LEVIATHAN_ENTRANCE("The Leviathan Entrance", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, new EscapeCrystalNotifyRegionEntrance(EscapeCrystalNotifyRegionEntranceOverlayType.DEPRIORITIZED_WITH_HIGHLIGHT, List.of(529188), false, true, EscapeCrystalNotifyRegionEntranceObjectType.GAME_OBJECT, ObjectID.DT2_SCAR_BOAT_CAMP), 8292),
    ...
    RAIDS_CHAMBERS_OF_XERIC("Chambers of Xeric", EscapeCrystalNotifyRegionType.RAIDS, EscapeCrystalNotifyRegionDeathType.UNSAFE_HCGIM, new EscapeCrystalNotifyRegionEntrance(EscapeCrystalNotifyRegionEntranceOverlayType.DEPRIORITIZED_WITH_HIGHLIGHT, null, EscapeCrystalNotifyRegionEntranceObjectType.GAME_OBJECT, ObjectID.RAIDS_DOORWAY).withClosest().withVarbitConstraints(List.of(Map.of(VarbitID.RAIDS_CLIENT_PROGRESS, value -> value == 0), Map.of(VarbitID.RAIDS_TIMER, value -> value == 0))), 12889, 13136, 13137, 13138, 13139, 13140, 13141, 13145, 13393, 13394, 13395, 13396, 13397, 13401),
