...
public enum EscapeCrystalNotifyRegion {
    ...
    BOSS_AMOXLIATL("Amoxliatl", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 5446, 6294, 6550),
    BOSS_ARAXXOR("Araxxor", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 14489),
    BOSS_ARTIO("Artio", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 7092),
    ...
    BOSS_CALVARION("Calvar'ion", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 7604),
    ...
    BOSS_DERANGED_ARCHAEOLOGIST("Deranged Archaeologist", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 14650),
    BOSS_DKS("Dagannoth Kings", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 11588, 11589),
    BOSS_DOOM_OF_MOKHAIOTL("Doom of Mokhaiotl", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 5268, 5269, 13668, 14180),
    ...
    BOSS_FORTIS_COLOSSEUM("Fortis Colosseum", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 7216, 7316),
    ...
    BOSS_HUEYCOATL("The Hueycoatl", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 5939),
    ...
    BOSS_KING_BLACK_DRAGON("King Black Dragon", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 9033),
    ...
    BOSS_OBOR("Obor", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 12441),
    ...
    BOSS_ROYAL_TITANS("Royal Titans", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 11669, 11925),
    BOSS_SARACHNIS("Sarachnis", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 7322),
    BOSS_SCURRIUS("Scurrius", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 13210),
    BOSS_SKOTIZO("Skotizo", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 9048),
    BOSS_SPINDEL("Spindel", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 6580),
    ...
    BOSS_VARDORVIS("Vardorvis", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 4405, 4661),
    ...
    BOSS_YAMA("Yama", EscapeCrystalNotifyRegionType.BOSSES, EscapeCrystalNotifyRegionDeathType.UNSAFE, 5789, 6045),
